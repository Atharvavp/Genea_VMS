/*
 * Vendored verbatim from MediaMTX v1.20.1:
 *   internal/servers/webrtc/reader.js
 *   https://github.com/bluenviron/mediamtx/blob/v1.20.1/internal/servers/webrtc/reader.js
 *
 * Copyright (c) 2019 Alessandro Ros. MIT License - see THIRD_PARTY_NOTICES.md.
 *
 * Vendored rather than loaded from the MediaMTX server so the UI keeps working
 * from one origin and cannot half-load when MediaMTX is restarting. Update it
 * whenever the pinned MediaMTX version changes.
 */
"use strict";
